...
export default function Loader({ brand = "Facebook" }) {
...
export const FriendCardSkeleton = () => (
  <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
    <Skeleton className="h-24 w-24 rounded-full mx-auto mb-4" aria-hidden="true" />
    <Skeleton className="h-4 w-3/4 mx-auto mb-2" aria-hidden="true" />
    <Skeleton className="h-8 w-full mb-2" aria-hidden="true" />
...
// Share Link URL Fix
export const getShareUrl = (platform, url) => {
  switch (platform) {
    case "facebook":
