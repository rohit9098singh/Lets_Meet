...
import { createOrUpdateBio } from '@/service/user.service'
...
const EditBio = ({isOpen,onClose,initialData,id,fetchProfile}) => {
  ...
  const handleEditBio = async(data) =>{
        try {
           ...
           await createOrUpdateBio(id,data)
  ...
  return (
     ...
     <DialogContent className = "sm:max-w-[425px]">
           <DialogHeader>
            ...
            <DialogDescription className='text-xs text-gray-400'>Follow Below</DialogDescription>
           </DialogHeader>
           <form onSubmit={handleSubmit(handleEditBio)}>
             <div className='grid gap-4 py-4'>
               ...
               <div className='grid grid-cols-4 items-center gap-4'>
                ...
                <Input id="relationShip" {...register("relationShip")} className="col-span-3" />
               </div>

               <div className='grid grid-cols-4 items-center gap-4'>
                <Label htmlFor="workPlace" className="text-right">Work Place</Label>
                <Input id="workPlace" {...register("workPlace")} className="col-span-3" />
               </div>
               ...
               <div className='grid grid-cols-4 items-center gap-4'>
                ...
                <Input id="homeTown" {...register("homeTown")} className="col-span-3" />
               </div>
             </div>
             <DialogFooter>
